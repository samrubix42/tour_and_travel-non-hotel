                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                ...
                                @elseif($currentFeaturedUrl)
                                <img src="{{ $currentFeaturedUrl }}" style="width:140px;height:90px;object-fit:cover;" class="rounded">
                                @endif
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                ...
                                <img src="{{ $currentThumbnailUrl }}" style="width:120px;height:80px;object-fit:cover;" class="rounded">
                                @endif
                            </div>
                        </div>
                        <div class="d-grid">
                            <button class="btn btn-primary" type="submit" wire:loading.attr="disabled">
                                ...
                                <span wire:loading wire:target="update"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Updating…</span>
                            </button>
                        </div>
                    </div>
                </div>
