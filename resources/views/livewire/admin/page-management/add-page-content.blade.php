<div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div wire:ignore>
                                    <textarea id="editor-add" class="form-control">{!! $page_content ?? '' !!}</textarea>
                                </div>
                                <input type="hidden" id="page_content_input_add" wire:model="page_content">
                            </div>
                            <hr class="my-3">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('admin.page.management') }}" class="btn btn-secondary">Cancel</a>
    ...
    <script>
        function initTinyAdd() {
            if (typeof tinymce === 'undefined') return;
            const textarea = document.getElementById('editor-add');
            if (!textarea) return;
            if (tinymce.get('editor-add')) tinymce.get('editor-add').remove();
            ...
            tinymce.init({
                ...
                setup: function (editor) {
                    editor.on('init', function () {
                        try {
                            const hidden = document.getElementById('page_content_input_add');
        ...
        document.addEventListener('livewire:init', function () {
            initTinyAdd();
            if (window.Livewire && Livewire.hook) Livewire.hook('message.processed', () => initTinyAdd());
        });
    </script>
</div>
